...
import type { AndroidBuildConfigType, CommonBuildConfigType, iOSBuildConfigType, WebBuildConfigType } from "../BuildConfigType";
...
export const commonIntegreatTestCmsBuildConfig: CommonBuildConfigType = { ...integreatPlatformBuildConfigs.common,
  ...integreatTestCms
};
export const webIntegreatTestCmsBuildConfig: WebBuildConfigType = { ...integreatPlatformBuildConfigs.web,
  ...integreatTestCms
};
export const androidIntegreatTestCmsBuildConfig: AndroidBuildConfigType = { ...integreatPlatformBuildConfigs.android,
  ...integreatTestCms,
...
export const iosIntegreatTestCmsBuildConfig: iOSBuildConfigType = { ...integreatPlatformBuildConfigs.ios,
  ...integreatTestCms,
